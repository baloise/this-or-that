    ...
    <section id="privacy">
        <section class="section">
            <div class="container content">
                ...
                <p>At ThisOrThat, accessible from https://baloise.github.io/this-or-that, one of our main priorities is
                    the privacy of our visitors. This Privacy Policy document contains types of information that is
                    collected and recorded by ThisOrThat and how we use it.</p>
                ...
                <p>ThisOrThat follows a standard procedure of using log files. These files log visitors when they visit
                ...
                <P>You may consult this list to find the Privacy Policy for each of the advertising partners of
                    ThisOrThat. Our Privacy Policy was created with the help of the <a
                ...
                <p>Third-party ad servers or ad networks uses technologies like cookies, JavaScript, or Web Beacons that
                    are used in their respective advertisements and links that appear on ThisOrThat, which are sent
                ...
                <p>Note that ThisOrThat has no access to or control over these cookies that are used by third-party
                    advertisers.</p>

                <h2>Third Party Privacy Policies</h2>

                <p>ThisOrThat's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising
                ...
                <p>ThisOrThat does not knowingly collect any Personal Identifiable Information from children under the
                ...
                <p>This Privacy Policy applies only to our online activities and is valid for visitors to our website
                    with regards to the information that they shared and/or collect in ThisOrThat. This policy is not
                ...
                <p>Images you uploaded are stored temporarily on our server as well as any survey and vote data you
                    contributed during the use of our services. Our server is saving all survey data including images
                    and votes only for 24 hours. After that period all survey data ist deleted and can not be
                    restored.</p>

                <h2>Data Protection</h2>

                <p>Please be advised that anyone with knowledge of the generated code to your survey can access your
                    survey including seeing your images, adding votes and managing your survey.</p>
