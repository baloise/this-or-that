                    ...
                    <div class="columns">
                        ...
                        <div class="column is-two-thirds-tablet is-half-desktop">
                            <div class="content is-center" v-if="!this.surveyCode">
                                ...
                                <h1 v-if="this.droppedFiles.length > 0">You have selected {{this.droppedFiles.length}}
                                    images to upload!</h1>
    ...
    export default class CreateSurveyContainer extends Vue {
        ...
        public async create() {
            ...
            try {
                ...
                const allBase64 = await Promise.all(this.droppedFiles.map(f => this.toBase64(f)));
                await Promise.all(allBase64.map(async file => {
