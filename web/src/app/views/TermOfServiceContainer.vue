    ...
    <section class="section">
        <div class="container content">
            ...
            <p>These Terms and Conditions ("Terms", "Terms and Conditions") govern your relationship with
                https://baloise.github.io/this-or-that website (the "Service") operated by ThisOrThat ("us", "we", or
                "our").</p>
            ...
            <p>ThisOrThat has no control over, and assumes no responsibility for, the content, privacy policies, or
                practices of any third party web sites or services. You further acknowledge and agree that ThisOrThat
            ...
            <p>You recognize and agree that by uploading any content (including, but not limited to designs, images,
                animations, videos, audio files, fonts, logos, illustrations, compositions, artworks, interfaces, text
                and literary works) through any means to the website, you confirm that you own all the relevant rights
                or received the appropriate license to upload/transfer/send the content. You agree and consent that the
                uploaded/transferred content may be publicly displayed at the website.</p>
            ...
            <p>In no event shall ThisOrThat, nor its directors, employees, partners, agents, suppliers, or affiliates,
            ...
            <p>ThisOrThat its subsidiaries, affiliates, and its licensors do not warrant that a) the Service will
            ...
            <p>These Terms shall be governed and construed in accordance with the laws of Switzerland, without regard to
