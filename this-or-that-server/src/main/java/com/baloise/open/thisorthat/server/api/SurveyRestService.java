 ...
 */
package com.baloise.open.thisorthat.server.api;

import com.baloise.open.thisorthat.server.api.dto.Error;
import com.baloise.open.thisorthat.server.api.dto.*;
...
import com.baloise.open.thisorthat.server.service.SurveyService;
    ...
    private Response errorHandler(Exception error) {
        ...
        try {
            ...
            return Response
                    ...
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.IMAGE_NOT_FOUND).message(e.getMessage()).build())
                    .build();
        } catch (UpdateFailedException e) {
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.UPDATE_FAILED_ERROR).message(e.getMessage()).build())
                    .build();
        } catch (ImageNotFoundException e) {
            return Response
                    .status(Response.Status.NOT_FOUND)
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.DELETE_FAILED_ERROR).message(e.getMessage()).build())
                    .build();
        } catch (SurveyNotFoundException e) {
            return Response
                    .status(Response.Status.NOT_FOUND)
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.SURVEY_NOT_FOUND).message(e.getMessage()).build())
                    .build();
        } catch (SurveyIncompleteException e) {
            return Response
                    .status(Response.Status.BAD_REQUEST)
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.SURVEY_INCOMPLETE).message(e.getMessage()).build())
                    .build();
        } catch (DatabaseException e) {
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.DATABASE_ERROR).message(e.getMessage()).build())
                    .build();
        } catch (AlgorithmException e) {
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
                    .entity(com.baloise.open.thisorthat.server.api.dto.Error.builder().error(ErrorCode.ALGORITHM_ERROR).message(e.getMessage()).build())
                    .build();
        } catch (Exception e) {
            return Response
                    .status(Response.Status.INTERNAL_SERVER_ERROR)
